    ...
    <section className="project" id="project">
      ...
      <div className="AboutProject__columns">
        <div className="AboutProject__column"> 
          ...
          <h3 className="AboutProject__text">Составление плана, работу над бэкендом, вёрстку, добавление функциональности и ;финальные доработки.</h3>
        </div>
        <div className="AboutProject__column"> 
          <h2 className="AboutProject__title">На выполнение диплома ушло 5 недель</h2>
          <h3 className="AboutProject__text">У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было соблюдать, чтобы успешно защититься.</h3>
        </div>
      </div> 
